...
int main() {
  ...
  cout << "\nResultados aplicados al sistema web:" << endl;

cout << "Preorden -> SistemaWeb, Usuarios, Registrar, Buscar, Inventario, Productos, Reportes" << endl;

cout << "Postorden -> Registrar, Buscar, Usuarios, Productos, Reportes, Inventario, SistemaWeb" << endl;

cout << "BFS -> SistemaWeb, Usuarios, Inventario, Registrar, Buscar, Productos, Reportes" << endl;
    return 0;
}